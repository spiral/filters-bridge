...
abstract class Filter extends SchematicEntity implements FilterInterface
{
    ...
    /**
     * Returns {@see true} in case that children filter is optional or {@see false} instead.
     */
    private function isOptional(string|int $field): bool
    {
     ...
     * @throws EntityExceptionInterface
     */
    private function hasBeenPassed(string|int $field): bool
    {
